...
2. Run SEED endpoint to generate PGN World Champions games with the filename as payload (exists enum with the existing filenames). Remember: When new world chess champion pgn file appears add it to existing Enum with the exact filename.
