...
interface AdminCoachRejectedEmailProps {
    coachName: string;
    coachEmail: string;
    reviewedBy: string;
...
export const AdminCoachRejectedEmail = ({
    coachName,
    coachEmail,
    reviewedBy,
    rejectionReason,
}: AdminCoachRejectedEmailProps) => {
    return (
        <Html>
            <Head />
            <Preview>Coach Rejected: {coachName}</Preview>
            <Body style={main}>
                <Container style={container}>
                    <Section style={headerSectionRejected}>
                        <Img
                            ...
                            style={logo}
                        />
                        <Heading style={headerTitle}>Coach Rejected ❌</Heading>
                    </Section>
...
export default AdminCoachRejectedEmail;