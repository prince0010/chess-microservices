...
export const lessonParentDataSeed: ILessonParentSeed[] = [
  ...
  },
  {
    ...
    lessonFactor: 0,
    story: 'Education',
    level: 'Defeat to Tik and Shelly',
    quantityToUnlockNext: 2, // defeat bot N1 and N2
    levelFrontend: 'Defeat to Tik and Shelly',
    showHint: false,
    pointsPerLesson: 0,
    isTest: false,
    isGame: false,
  ...
  },
  {
    ...
    lessonFactor: 0,
    story: 'Education',
    level: LessonNameAsGame.RIGHT_PIECE_ON_RIGHT_SQUARE_GAME,
    quantityToUnlockNext: 3, // complete Level 3 of Right piece on right square
    levelFrontend: LessonNameAsGame.RIGHT_PIECE_ON_RIGHT_SQUARE_GAME,
    showHint: false,
    pointsPerLesson: 0,
    isTest: false,
    isGame: true,
  ...
  },
  {
    ...
    lessonFactor: 0,
    story: 'Education',
    level: LessonNameAsGame.MEMORY_TESTER_GAME,
    quantityToUnlockNext: 3, // complete Level 3 of Memory Tester
    levelFrontend: LessonNameAsGame.MEMORY_TESTER_GAME,
    showHint: false,
    pointsPerLesson: 0,
    isTest: false,
    isGame: true,
