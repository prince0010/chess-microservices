...
export class Migration1761088659072 implements MigrationInterface {
  name = 'Migration1761088659072';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`lesson_advanced\` ADD \`movesTree\` longtext COLLATE "utf8mb4_bin" NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`lesson_advanced\` ADD \`metadata\` longtext COLLATE "utf8mb4_bin" NOT NULL`,
    );
  }
}
