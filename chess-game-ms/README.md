...
# Chess Games Microservice

This is the Games module. All data related with Tetris game and Guess Square game are here.

## Docker config documentation

The file with name `Dockerfile` is what we will use for Development environment.
The file with name `Dockerfile.test` is what we will use for Testing environment.
